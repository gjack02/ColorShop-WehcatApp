<template>
	<view>
		<custom bgColor="bg-blue" :isBack="true">
			<block slot="backText">返回</block>
			<block slot="content">会员专享</block>
		</custom>
		<view class="bg-blue">
			<image src="https://image.weilanwl.com/qhShop/hyzx01.jpg" mode="widthFix" class="response"></image>
			<!-- 缩略图卡片单列 -->
					...
					<view class="content">
						...
						<view class="flex justify-between align-end">
							...
							<view class="padding-left-xl text-right">
								<button class="cu-btn bg-blue round shadow sm"><text class="icon-lightfill"> </text>抢购</button>
							</view>
						</view>
					</view>
				</view>
