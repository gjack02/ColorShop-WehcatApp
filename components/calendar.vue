			...
			<view class="uni-calendar__wrapper">
                ...
                canlender.lunar.gzYear +
                  ...
                  '年)'
					...
					<swiper v-else :style="{ height: domHeihgt + 'px' }" :current="currentIndex" :vertical="slide === 'vertical' ? true : false"
					 :duration="duration" class="uni-calendar__body" circular skip-hidden-item-layout @animationfinish="animationfinish"
					 @change="change">
...
<script>
	...
	import uniCalendarItem from './calendar-item'
	export default {
		name: 'UniCalendar',
		components: {
			uniCalendarItem
